                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <td><i class=\"fab fa-sketch fa-lg text-warning me-3\"></i> <strong>" . $row['id_user'] . "</strong></td>
                                        <td>" . $row['CodeCin'] . "</td>
                                        ...
                                        <td>" . $row['log'] . "</td>";
                                                if ($row['status'] == 1) {
                                                    echo "<td><span class=\"badge bg-label-success me-1\">OnLline</span></td>";
                                                } else {
                                                    echo "<td><span class=\"badge bg-label-warning me-1\">OffLline</span></td>";
                                                }
                                                if ($row['type_user'] == "admin") {
                                                    echo "<td><span class=\"badge bg-label-info me-1\">" . $row['type_user'] . "</span></td>";
                                                } else {
                                                    echo "<td><span class=\"badge bg-label-secondary me-1\">" . $row['type_user'] . "</span></td>";
                                                }
                                                echo "<td>
                                                <div class=\"dropdown\">
                                                    ...
                                                    <div class=\"dropdown-menu\">
                                                        <a class=\"dropdown-item\"  data-bs-toggle=\"modal\" data-bs-target=\"#modal" . $row["id_user"] . "\"><i class=\"bx bx-edit-alt me-1\"></i> Edit</a>
                                        ...
                                        echo "<div class=\"modal fade\" id=\"modal" . $row["id_user"] . "\" tabindex=\"-1\" style=\"display: none;\" aria-hidden=\"true\">
                                                ...
                                                <div class=\"modal-content container-xxl\">
                                                    ...
                                                    <div class=\"mb-3\" style=\"display:none;\">
                                                        ...
                                                        <input type=\"text\" value=\"\" id=\"basic-icon-default-id\" name=\"id\" class=\"form-control\" placeholder=\"Adresse\" aria-label=\"ID\" aria-describedby=\"basic-icon-default-id\">
                                                        </div>
                                                    </div>
                                                    <div class=\"row g-2\">
                                                        <div class=\"col mb-0\">
                                                        ...
                                                        <div class=\"input-group input-group-merge\">
                                                            ...
                                                            <input type=\"text\"  value=\"\" required id=\"basic-icon-default-user\" name=\"nom\" class=\"form-control\" placeholder=\"Nom complet\" aria-label=\"Nom\" aria-describedby=\"basic-icon-default-Nom\">
                                                        </div>
                                                        </div>
                                                        <div class=\"col mb-0\">
                                                        ...
                                                        <div class=\"input-group input-group-phone\">
                                                            ...
                                                            <input type=\"text\"  value=\"\" pattern=\"(06|05|08|07)[0-9]{8}\" name=\"tele\" required id=\"basic-icon-phone\" class=\"form-control\" placeholder=\"(06|05|08|07)XXXXXXXX\" aria-label=\"Telephone\" aria-describedby=\"basic-icon-default-Telephone\">
                                                        </div>
                                                    </div>
                                                    </div>
                                                    <div class=\"mb-3\">
                                                        ...
                                                        <textarea type=\"text\"  value=\"\" required id=\"basic-icon-default-location-plus\" name=\"Adresse\" class=\"form-control\" placeholder=\"Adresse\" aria-label=\"Adresse\" aria-describedby=\"basic-icon-default-Adresse\"></textarea>
                                                        </div>
                                                    </div>
